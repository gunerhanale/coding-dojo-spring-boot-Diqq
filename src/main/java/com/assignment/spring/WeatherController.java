...
//        
//        //added variable below to fetch it as a environment
...
//    }
    ...
    public Result weather(HttpServletRequest request) {
        ...
        //If It works without error, try and finally blocks will work and is ended process. Otherwise Try, Catch and finally blocks will will work by order...
        try {
        	ResponseEntity<WeatherResponse> response = restTemplate.getForEntity(url, WeatherResponse.class);
        	weatherEntity = mapper(response.getBody());
